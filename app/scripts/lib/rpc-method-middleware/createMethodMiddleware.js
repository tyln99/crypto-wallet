...
/**
 * A middleware that implements the RPC methods defined in the handlers
 * directory.
 *
 ...
 * @returns {void} req: Object, res: Object, next: Function, end: Function
 */
export default function createMethodMiddleware(opts) {
  log('createMethodMiddleware: ', opts)
